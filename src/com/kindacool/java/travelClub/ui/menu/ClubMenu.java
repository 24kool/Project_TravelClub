package com.kindacool.java.travelClub.ui.menu;

import com.kindacool.java.travelClub.ui.console.ClubConsole;
...
public class ClubMenu {
    ...
    private int selectMenu(){
        ...
        if(menuNumber >= 0 && menuNumber <= 6){
            ...
            System.out.println("It's an invalid number --->" + menuNumber);
            return -1;
        }
